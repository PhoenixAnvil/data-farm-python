...
from data_farm.l0_domain.generators.boolean import BooleanGenerator
...
class BooleanPlanner:
    ...
    def compile(
        ...
        gen = BooleanGenerator(ctx.rng, choices, field_def)
        return (SqlType.BOOLEAN, gen.generate)
    ...
    def plan(
        ...
        value = BooleanGenerator(ctx.rng, choices, field_def).generate()
        if value is None:
            return None
